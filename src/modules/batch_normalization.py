...
class BatchNormalization(tf.keras.layers.Layer):
    ...
    def build(self, input_shapes):
        ...
        self.var = tf.Variable(tf.ones(shape=statistics_shape, dtype=tf.float32), name='variance')
